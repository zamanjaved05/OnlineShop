<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow"style="background:#3c0e60">

    <!-- Sidebar Toggle (Topbar) -->
    <button id="sidebarToggleTop" class="btn btn-link  rounded-circle mr-3"style="background:#170029">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow"style="background:#170029;border-radius: 50px;">
